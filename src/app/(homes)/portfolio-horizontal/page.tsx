...
import PortfolioHorizontalSlider from "@/components/portfolio-slider/portfolio-horizontal-slider";

export const metadata: Metadata = {
  title: "Redox - Portfolio Horizontal and Portfolio Next js Template",
  description:
